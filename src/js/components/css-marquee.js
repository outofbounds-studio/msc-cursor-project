...
function initCSSMarquee() {
  ...
  // Store the observer in a global variable for cleanup
  window._marqueeObserver = observer;
}

// Add cleanup function
function destroyCSSMarquee() {
...
document.addEventListener('DOMContentLoaded', function() {
  console.log('📄 DOM Content Loaded - Starting CSS Marquee initialization');
  initCSSMarquee();
}); 