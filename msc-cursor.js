...
// Version: 1.0.4 updated 13/01/2026 - Added expanding feature pills for styles page
...
(function() {
    ...
    // === Menu: Osmo scaling hamburger (data-navigation-*) ===
    ...
    async function init() {
        ...
        // Osmo scaling hamburger navigation (data-navigation-*)
        ...
        cleanupScrollSequence() {
            try {
                ...
                sequenceContainers.forEach(container => {
                    ...
                    // Clean up skip buttons references (buttons are created in Webflow, so we just reset state)
                    if (container._scrollSequenceSkipButtons) {
                        const { jumpToBottomBtn, jumpToTopBtn } = container._scrollSequenceSkipButtons;
    ...
    const components = {
        ...
        initExpandingFeaturePills() {
            try {
                ...
                console.log('Expanding feature pills initialized');
            } catch (error) {
